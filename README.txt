...
You can stop copycats from easily taking away your hard work. Protect your text, images, and other media with this lightweight plugin. Keep your content safe by deactivating right click, copying and text highlighting even when JavaScript is disabled.
...
<li> Upload the plugin file to your WordPress</li>
<li> Activate the plugin.</li>
<li> After activating check your WordPress settings, you will see Son Content Protector, click it and adjust the settings as you like.</li>
</ul>


== Frequently Asked Questions ==
<ul>
<li> Q: How do I use the plugin?</li>

<li> A: To use the plugin, go to the plugin's settings page located in your WordPress Settings on the dashboard to turn on or off features.</li>

<li> Q: I'm having a problem with the plugin. What should I do?</li>

<li> A: Please contact us on support email tsquare@iamtsquare07.com with issues and we will try to fix it ASAP.</li>
</ul>
